...
(async () => {
  ...
  check('teaser viser «22 skjulte merker»', html.includes('22 skjulte merker'), html.match(/\d+ skjulte merker/)?.[0]);
  check('teller viser av 63 merker', html.includes('av 63 merker'), html.match(/av \d+ merker/)?.[0]);
